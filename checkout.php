    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-sm-6 offset-sm-3 jumbotron">
          <h3 class="mb-5">Welcome to GoWise Payment Page</h3>
          <form method="post" action="./paymentdone.php">
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input id="ORDER_ID" class="form-control" tabindex="1" maxlength="20" size="20" name="ORDER_ID" 
                       ...
                       <!--This rand function is for randomly allocating the number to the order id
                           Here readonly means we cannot edit the input field-->
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-8">
                <input id="CUST_ID" class="form-control" tabindex="2" maxlength="12" size="12" name="CUST_ID" 
                       autocomplete="off" value="<?php if (isset($stuEmail)) {
                                                                              echo $stuEmail;
                                                                              } ?>" readonly>
              </div>
            </div>
            ...
            <div class="text-center">
              <!--this is the check out button and after submiting the form it will redirect to the paymentdone.php-->
