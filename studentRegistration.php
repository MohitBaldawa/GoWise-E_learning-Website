...
<!--This form also taken from the Bootstrap
    This is in action when "get started" button gets clicked. Refference of this id is given in the folder-->
<form role="form" id="stuRegForm">
   ...
   <div class="form-group">
     <i class="fas fa-key"></i><label for="stupass" class="pl-2 font-weight-bold">New
       Password</label><small id="statusMsg3"></small>
