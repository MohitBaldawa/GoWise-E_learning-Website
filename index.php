...
?>  
    ...
    <div class="container-fluid remove-vid-marg">
      <div class="vid-parent">
        <!--Here "playsinline autoplay muted loop" will play the video in a loop which is muted -->
        <video playsinline autoplay muted loop> 
          <source src="video/banvid.mp4" />
        </video>
        <div class="vid-overlay"></div> <!-- This is for applying the overlay on the video of blue color -->
      </div>
      <div class="vid-content" >
        <h1 class="my-content">Welcome to iSchool</h1> <!--For it on the video of home screen-->
        <small class="my-content">Learn and Implement</small><br />
        <?php    
              if(!isset($_SESSION['is_login'])) 
              {   // Here if the user session is logged in i.e. True then 
                // Here #StuREGModal is taken from the Bootstrap for registretion
    ...
    <div class="container-fluid bg-danger txt-banner"> 
        <div class="row bottom-banner">
          <div class="col-sm">
            <!--Here in <i> tag class is taken from font awesome to print the icons in front of text -->
    ...
    <!--Contct us Ended-->
     ...
     <!--This code is writen using the Carousel Plugin -->
