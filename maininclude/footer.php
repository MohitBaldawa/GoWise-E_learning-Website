 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2020 || Designed By Mohit & Sunil || <?php   
 ...
 <!-- End Footer -->
    ...
    <!-- Start Student Registration Modal 
          ...
          This is taken from the bootstrap-> content-> Modal; 
          This will active when "Get Started" button or Sign up Button get clicked-->
